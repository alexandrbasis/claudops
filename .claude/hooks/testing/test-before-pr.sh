...
# Wired:     No (project-specific — configure TEST_CMD first)
#
...
#
# Configuration:
#   TEST_CMD   — test command (default: "npm run test:silent")
#   BUILD_CMD  — build/typecheck command, empty to skip (default: "npx tsc --noEmit")
